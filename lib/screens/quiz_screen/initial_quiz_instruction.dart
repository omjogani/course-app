...
class InitialQuizInstruction extends StatefulWidget {
  const InitialQuizInstruction({Key? key}) : super(key: key);
    ...
    return Scaffold(
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          // Json Available,
          int totalQuiz = decodedJsonData["tutorials"]["test1"]["length"];
          dynamic listQuiz = decodedJsonData["tutorials"]["test1"];
